      ...
      <div className="px-4 lg:container py-4 lg:py-5 relative flex justify-between items-center">
        <div className="hidden md:flex justify-start flex-1 items-center space-x-3 sm:space-x-8 lg:space-x-10">
          ...
          <div style={{marginLeft:"11rem"}}>
            <img src="https://eazr.s3.ap-south-1.amazonaws.com/1678698086077-seal-of-karnataka.png" style={{height:"60px", width:"60px"}} />
          </div>
          <div style={{ display: "flex", flexDirection: "column" }}>
            <h3>Department of Youth Empowerment and Sports</h3>
